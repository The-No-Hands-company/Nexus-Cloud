...
export const apiRouteManifest = [
  ...
  { method: "POST", path: "/v1/nodes/trust/bulk", description: "Apply trust actions across multiple nodes" },
  { method: "POST", path: "/v1/nodes/:nodeId/trust/promote", description: "Promote a node trust state to trusted" },
  { method: "POST", path: "/v1/nodes/:nodeId/trust/quarantine", description: "Quarantine a node trust state" },
  { method: "POST", path: "/v1/nodes/:nodeId/trust/revoke", description: "Revoke a node trust state" },
  { method: "POST", path: "/v1/workloads/plan", description: "Produce a placement plan for a workload" },
  { method: "POST", path: "/v1/workloads/:workloadId/run", description: "Start a workload through the data plane runtime adapter" },
  { method: "POST", path: "/v1/workloads/:workloadId/stop", description: "Stop active runtime units for a workload" },
  ...
  { method: "GET", path: "/api/v1/compliance/phantom", description: "List PHANTOM security compliance entries (?status=failing|all)" },
  { method: "GET", path: "/api/v1/compliance/phantom/summary", description: "Counts-only PHANTOM compliance summary for lightweight polling" },
  { method: "GET", path: "/api/v1/trust/summary", description: "Counts-only trust lifecycle summary for lightweight polling" },
  ...
  { method: "POST", path: "/api/v1/guardian/:scope/:subjectId/approve", description: "Approve a Guardian-controlled subject" },
  { method: "POST", path: "/api/v1/guardian/:scope/:subjectId/deny", description: "Deny a Guardian-controlled subject" },
  { method: "POST", path: "/api/v1/guardian/:scope/:subjectId/suspend", description: "Suspend a Guardian-controlled subject" },
  { method: "POST", path: "/api/v1/guardian/:scope/:subjectId/quarantine", description: "Quarantine a Guardian-controlled subject" },
  { method: "GET", path: "/api/v1/audit", description: "Query durable audit log (?subjectId=&source=&level=&kind=&from=&to=&limit=)" },
